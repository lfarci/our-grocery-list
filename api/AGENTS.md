...
- Apply the C# Copilot guidance in `.github/instructions/csharp.instructions.md` (present in this repo) when working in this directory so code conventions stay consistent.
