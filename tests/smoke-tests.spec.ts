...
test.describe('Grocery List Application - Smoke Tests', () => {
  ...
  test('Main screen displays list title and add form', async ({ page }) => {
  ...
  test('Empty state message displays when no items', async ({ page }) => {
