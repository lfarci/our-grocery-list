...
- Follow the Playwright guidance in `.github/instructions/playwright.instructions.md` (and React/TypeScript instructions when applicable), all of which are present in this repo, so tests reflect project conventions.
